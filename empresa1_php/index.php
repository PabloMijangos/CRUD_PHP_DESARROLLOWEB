...
?>
	  ...
	  <div class="container">
		  <form class="d-flex" action="Crud_agregar_empleado.php" method="POST">
			  <div class="col">
					 ...
					 $resultado = $db_conexion->use_result();   
						while($fila = $resultado->fetch_assoc()){
							echo "<tr data-id=". $fila['id_empleado'] .">";
								...
								echo"<td><a href='Crud_editar_empleado.php?id=".$fila['id_empleado']."' class='btn btn-info'>Editar Empleado</a></td>";
								echo"<td><a href='Crud_eliminar_empleado.php?id=".$fila['id_empleado']."' class='btn btn-danger'>Eliminar </a></td>";
